...
- **Project Card Tilt Effects** on hover
- **Animated Skill Cards** with hover interactions
...
5. **Experience** - Leadership activities and involvement
6. **Contact** - Contact form and social media links

## 🚀 Featured Projects

### 🔐 FidoPay: Passwordless Payment App
...
- **B.E. Information Science and Engineering** - MVJ College of Engineering (2022-Present)
- **Event Organizer** - Swayam College Fest (2024)
- **NSS Cleanup Drive Participant** (2023)
...
### Colors
The color scheme uses CSS custom properties and can be easily modified in `styles.css`:
...
- **Fast JavaScript** - Event delegation and optimized DOM manipulation
